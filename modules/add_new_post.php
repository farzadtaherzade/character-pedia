...
if (empty($errors)) {
    print_r($character);
    $sql_query = "INSERT INTO characters (title, `desc`, cover, author_id,birthdate, source_character) 
    VALUES ('$character[title]', '$character[desc]', '$character[image]', '$character[author]', '$character[birthdate]', '$character[source_character]')";
